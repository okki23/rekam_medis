...
class M_specialist extends Parent_Model { 
  
 
  var $nama_tabel = 'm_specialist';
  var $daftar_field = array('id','nama_specialist');
  var $primary_key = 'id';
  ...
  public function fetch_specialist(){
      
       $getdata = $this->db->get('m_specialist')->result();
       $data = array();  
      $no = 1;
       ...
       public function fetch_specialist_parent(){
      
       $sql = "select a.*,b.nama_komp_biaya,c.nama_pelayanan,d.nama_satuan from m_specialist a
